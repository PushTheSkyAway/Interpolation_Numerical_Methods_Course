...
def main():
    ...
    for x in interpolation_data["distance"]:
        fi_functions.append(make_fi_function(x, interpolation_data["distance"]))
    

    itrpl_func = lagrange_interpolation(fi_functions,interpolation_data["elevation"])
    ...
    plt.legend(["Exact function","Interpolated function", "Interpolation points"])
